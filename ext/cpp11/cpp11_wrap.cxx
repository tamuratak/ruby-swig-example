...
#define SWIGTYPE_p_std__allocatorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_t swig_types[9]
#define SWIGTYPE_p_std__lessT_std__string_t swig_types[10]
#define SWIGTYPE_p_std__mapT_std__string_std__string_std__lessT_std__string_t_std__allocatorT_std__pairT_std__string_const_std__string_t_t_t swig_types[11]
#define SWIGTYPE_p_std__mapT_std__string_std__string_std__lessT_std__string_t_std__allocatorT_std__pairT_std__string_const_std__string_t_t_t__iterator swig_types[12]
#define SWIGTYPE_p_std__mapT_std__string_std__string_std__lessT_std__string_t_std__allocatorT_std__pairT_std__string_const_std__string_t_t_t__reverse_iterator swig_types[13]
#define SWIGTYPE_p_std__vectorT_std__string_std__allocatorT_std__string_t_t swig_types[14]
#define SWIGTYPE_p_std__vectorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__allocatorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t swig_types[15]
...
SWIGINTERN std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > > *std_vector_Sl_std_vector_Sl_std_string_Sg__Sg__dup(std::vector< std::vector< std::string > > *self){
      return new std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > >(*self);
    }
SWIGINTERN VALUE std_vector_Sl_std_vector_Sl_std_string_Sg__Sg__inspect(std::vector< std::vector< std::string > > *self){
      std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > >::const_iterator i = self->begin();
      std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > >::const_iterator e = self->end();
      const char *type_name = swig::type_name< std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > > >();
      VALUE str = rb_str_new2(type_name);
      str = rb_str_cat2( str, " [" );
      bool comma = false;
      VALUE tmp;
	...
	{
	  if (comma) str = rb_str_cat2( str, "," );
	  tmp = swig::from< std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > >::value_type >( *i );
	  tmp = rb_inspect( tmp );
	  str = rb_str_buf_append( str, tmp );
	}
      str = rb_str_cat2( str, "]" );
...
SWIGINTERN VALUE std_vector_Sl_std_vector_Sl_std_string_Sg__Sg__to_a(std::vector< std::vector< std::string > > *self){
      std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > >::const_iterator i = self->begin();
      std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > >::const_iterator e = self->end();
      VALUE ary = rb_ary_new2( std::distance( i, e ) );
      VALUE tmp;
...
SWIGINTERN VALUE std_vector_Sl_std_vector_Sl_std_string_Sg__Sg__to_s(std::vector< std::vector< std::string > > *self){
      std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > >::iterator i = self->begin();
      std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > >::iterator e = self->end();
      VALUE str = rb_str_new2( "" );
      VALUE tmp;
      for ( ; i != e; ++i )
	{
...
SWIGINTERN VALUE std_vector_Sl_std_vector_Sl_std_string_Sg__Sg__slice(std::vector< std::vector< std::string > > *self,std::vector< std::vector< std::string > >::difference_type i,std::vector< std::vector< std::string > >::difference_type length){
      if ( length < 0 )
        return Qnil;
      std::size_t len = self->size();
      if ( i < 0 ) {
        if ( i + static_cast<std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > >::difference_type>(len) < 0 )
          return Qnil;
        else
          i = len + i;
      }
      std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > >::difference_type j = length + i;
      if ( j > static_cast<std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > >::difference_type>(len) )
        j = len;

      VALUE r = Qnil;
      try {
	r = swig::from< const std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > >* >( swig::getslice(self, i, j) );
      }
      catch( std::out_of_range ) {
      }
      return r;
    }
SWIGINTERN std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > > *std_vector_Sl_std_vector_Sl_std_string_Sg__Sg__each(std::vector< std::vector< std::string > > *self){
	if ( !rb_block_given_p() )
	  rb_raise( rb_eArgError, "no block given");
	...
	for ( ; i != e; ++i )
	  {
	    r = swig::from< std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > >::value_type >(*i);
	    rb_yield(r);
	  }
	
	return self;
      }
SWIGINTERN VALUE std_vector_Sl_std_vector_Sl_std_string_Sg__Sg____delete2__(std::vector< std::vector< std::string > > *self,std::vector< std::vector< std::string > >::value_type const &i){
      VALUE r = Qnil;
      return r;
    }
SWIGINTERN std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > > *std_vector_Sl_std_vector_Sl_std_string_Sg__Sg__select(std::vector< std::vector< std::string > > *self){
      if ( !rb_block_given_p() )
	rb_raise( rb_eArgError, "no block given" );

      std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > >* r = new std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > >();
      std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > >::const_iterator i = self->begin();
      std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > >::const_iterator e = self->end();
      for ( ; i != e; ++i )
	{
	  VALUE v = swig::from< std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > >::value_type >(*i);
	  if ( RTEST( rb_yield(v) ) )
	    self->insert( r->end(), *i);
	}
...
SWIGINTERN VALUE std_vector_Sl_std_vector_Sl_std_string_Sg__Sg__delete_at(std::vector< std::vector< std::string > > *self,std::vector< std::vector< std::string > >::difference_type i){
      VALUE r = Qnil;
      try {
	std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > >::iterator at = swig::getpos(self, i);
	r = swig::from< std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > >::value_type >( *(at) );
	self->erase(at); 
      }
      catch (std::out_of_range)
	{
...
SWIGINTERN VALUE std_vector_Sl_std_vector_Sl_std_string_Sg__Sg__at(std::vector< std::vector< std::string > > const *self,std::vector< std::vector< std::string > >::difference_type i){
      VALUE r = Qnil;
      try {
	r = swig::from< std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > >::value_type >( *(swig::cgetpos(self, i)) );
      }
      catch( std::out_of_range ) {
      }
      return r;
    }
SWIGINTERN VALUE std_vector_Sl_std_vector_Sl_std_string_Sg__Sg____getitem____SWIG_0(std::vector< std::vector< std::string > > const *self,std::vector< std::vector< std::string > >::difference_type i,std::vector< std::vector< std::string > >::difference_type length){
      if ( length < 0 )
        return Qnil;
      std::size_t len = self->size();
      if ( i < 0 ) {
...
SWIGINTERN VALUE std_vector_Sl_std_vector_Sl_std_string_Sg__Sg____getitem____SWIG_1(std::vector< std::vector< std::string > > const *self,std::vector< std::vector< std::string > >::difference_type i){
      VALUE r = Qnil;
      try {
	r = swig::from< std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > >::value_type >( *(swig::cgetpos(self, i)) );
      }
...
SWIGINTERN VALUE std_vector_Sl_std_vector_Sl_std_string_Sg__Sg____getitem____SWIG_2(std::vector< std::vector< std::string > > const *self,VALUE i){
      if ( rb_obj_is_kind_of( i, rb_cRange ) == Qfalse ) {
        rb_raise( rb_eTypeError, "not a valid index or range" );
      }
      ...
      return swig::from< std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > >* >( swig::getslice(self, s, e+1) );
    }
SWIGINTERN VALUE std_vector_Sl_std_vector_Sl_std_string_Sg__Sg____setitem____SWIG_0(std::vector< std::vector< std::string > > *self,std::vector< std::vector< std::string > >::difference_type i,std::vector< std::vector< std::string > >::value_type const &x){
	if ( i >= static_cast<std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > >::difference_type>( self->size()) )
          swig::resize( self, i+1, x );
        else
          *(swig::getpos(self, i)) = x;

	return swig::from< std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > >::value_type >( x );
      }
SWIGINTERN VALUE std_vector_Sl_std_vector_Sl_std_string_Sg__Sg____setitem____SWIG_1(std::vector< std::vector< std::string > > *self,std::vector< std::vector< std::string > >::difference_type i,std::vector< std::vector< std::string > >::difference_type length,std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > > const &v){
      ...
      VALUE r = Qnil;
      swig::setslice(self, i, j, v);
      r = swig::from< const std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > >* >( &v );
      return r;
    }
SWIGINTERN std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > > *std_vector_Sl_std_vector_Sl_std_string_Sg__Sg__reject_bang(std::vector< std::vector< std::string > > *self){
      if ( !rb_block_given_p() )
	rb_raise( rb_eArgError, "no block given" );

      self->erase( std::remove_if( self->begin(), self->end(),
            swig::yield< std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > >::value_type >() ), self->end() );
      return self;
    }
SWIGINTERN VALUE std_vector_Sl_std_vector_Sl_std_string_Sg__Sg__pop(std::vector< std::vector< std::string > > *self){
      if (self->empty()) return Qnil;
...
SWIGINTERN std::vector< std::vector< std::string > >::value_type const std_vector_Sl_std_vector_Sl_std_string_Sg__Sg__push(std::vector< std::vector< std::string > > *self,std::vector< std::vector< std::string > >::value_type const &e){
      self->push_back( e );
      return e;
    }
SWIGINTERN std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > > *std_vector_Sl_std_vector_Sl_std_string_Sg__Sg__reject(std::vector< std::vector< std::string > > *self){
      if ( !rb_block_given_p() )
	rb_raise( rb_eArgError, "no block given" );
      ...
      std::remove_copy_if( self->begin(), self->end(),              
			   std::back_inserter(*r),
			   swig::yield< std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > >::value_type >() );
      return r;
    }
SWIGINTERN VALUE std_vector_Sl_std_vector_Sl_std_string_Sg__Sg__shift(std::vector< std::vector< std::string > > *self){
      if (self->empty()) return Qnil;
      std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > >::value_type x = self->front();
      self->erase( self->begin() );
      return swig::from< std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > >::value_type >( x );
    }
SWIGINTERN std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > > *std_vector_Sl_std_vector_Sl_std_string_Sg__Sg__insert__SWIG_0(std::vector< std::vector< std::string > > *self,std::vector< std::vector< std::string > >::difference_type pos,int argc,VALUE *argv,...){
      std::size_t len = self->size();
      std::size_t   i = swig::check_index( pos, len, true );
      std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > >::iterator start;

      VALUE elem = argv[0];
      int idx = 0;
      try {
	std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > >::value_type val = swig::as<std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > >::value_type>( elem, true );
	if ( i >= len ) {
	  self->resize(i-1, val);
	  return self;
	}
	...
	for ( ++idx; idx < argc; ++idx )
	  {
	    elem = argv[idx];
	    val = swig::as<std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > >::value_type>( elem );
	    self->insert( start++, val );
	  }
      ...
      catch( std::invalid_argument )
	{
	  rb_raise( rb_eArgError, "%s",
		    Ruby_Format_TypeError( "", 
					   swig::type_name<std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > >::value_type>(),
					   __FUNCTION__, idx+2, elem ));
	}
...
SWIGINTERN std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > > *std_vector_Sl_std_vector_Sl_std_string_Sg__Sg__unshift(std::vector< std::vector< std::string > > *self,int argc,VALUE *argv,...){
      for ( int idx = argc-1; idx >= 0; --idx )
	{
	  std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > >::iterator start = self->begin();
	  VALUE elem = argv[idx];
	  try {
	    std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > >::value_type val = swig::as<std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > >::value_type>( elem, true );
	    self->insert( start, val );
...
SWIGINTERN std::vector< std::vector< std::string > >::iterator std_vector_Sl_std_vector_Sl_std_string_Sg__Sg__insert__SWIG_1(std::vector< std::vector< std::string > > *self,std::vector< std::vector< std::string > >::iterator pos,std::vector< std::vector< std::string > >::value_type const &x){ return self->insert(pos, x); }
SWIGINTERN void std_vector_Sl_std_vector_Sl_std_string_Sg__Sg__insert__SWIG_2(std::vector< std::vector< std::string > > *self,std::vector< std::vector< std::string > >::iterator pos,std::vector< std::vector< std::string > >::size_type n,std::vector< std::vector< std::string > >::value_type const &x){ self->insert(pos, n, x); }
...
/*
  Document-method: Mylib::Stl::GC_VALUE.inspect
...
/*
  Document-method: Mylib::Stl::GC_VALUE.to_s
...
/*
  Document-method: Mylib::Stl::ConstIterator.dup
...
/*
  Document-method: Mylib::Stl::ConstIterator.inspect
...
/*
  Document-method: Mylib::Stl::ConstIterator.to_s
...
/*
  Document-method: Mylib::Stl::ConstIterator.==
...
/*
  Document-method: Mylib::Stl::Iterator.dup
...
/*
  Document-method: Mylib::Stl::Iterator.inspect
...
/*
  Document-method: Mylib::Stl::Iterator.to_s
...
/*
  Document-method: Mylib::Stl::Iterator.==
...
static swig_class SwigClassStdVecString;


/*
  Document-method: Mylib::Stl::StdVecString.dup
...
*/
SWIGINTERN VALUE
_wrap_StdVecString_dup(int argc, VALUE *argv, VALUE self) {
...
/*
  Document-method: Mylib::Stl::StdVecString.inspect
...
*/
SWIGINTERN VALUE
_wrap_StdVecString_inspect(int argc, VALUE *argv, VALUE self) {
  std::vector< std::string > *arg1 = (std::vector< std::string > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  VALUE result;
...
/*
  Document-method: Mylib::Stl::StdVecString.to_a

  call-seq:
    to_a -> VALUE

Convert StdVecString to an Array.
*/
SWIGINTERN VALUE
_wrap_StdVecString_to_a(int argc, VALUE *argv, VALUE self) {
  std::vector< std::string > *arg1 = (std::vector< std::string > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  VALUE result;
...
/*
  Document-method: Mylib::Stl::StdVecString.to_s
...
*/
SWIGINTERN VALUE
_wrap_StdVecString_to_s(int argc, VALUE *argv, VALUE self) {
  std::vector< std::string > *arg1 = (std::vector< std::string > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  VALUE result;
...
/*
  Document-method: Mylib::Stl::StdVecString.slice

  call-seq:
    slice(i, length) -> VALUE

Return a slice (portion of) the StdVecString.
*/
SWIGINTERN VALUE
_wrap_StdVecString_slice(int argc, VALUE *argv, VALUE self) {
  std::vector< std::string > *arg1 = (std::vector< std::string > *) 0 ;
...
/*
  Document-method: Mylib::Stl::StdVecString.each

  call-seq:
    each -> StdVecString

Iterate thru each element in the StdVecString.  A block must be provided.
*/
SWIGINTERN VALUE
_wrap_StdVecString_each(int argc, VALUE *argv, VALUE self) {
  std::vector< std::string > *arg1 = (std::vector< std::string > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  std::vector< std::string,std::allocator< std::string > > *result = 0 ;
...
SWIGINTERN VALUE
_wrap_StdVecString___delete2__(int argc, VALUE *argv, VALUE self) {
  std::vector< std::string > *arg1 = (std::vector< std::string > *) 0 ;
...
/*
  Document-method: Mylib::Stl::StdVecString.select

  call-seq:
    select -> StdVecString

Iterate thru each element in the StdVecString and select those that match a condition.  A block must be provided.
*/
SWIGINTERN VALUE
_wrap_StdVecString_select(int argc, VALUE *argv, VALUE self) {
  std::vector< std::string > *arg1 = (std::vector< std::string > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  std::vector< std::string,std::allocator< std::string > > *result = 0 ;
...
/*
  Document-method: Mylib::Stl::StdVecString.delete_at
...
*/
SWIGINTERN VALUE
_wrap_StdVecString_delete_at(int argc, VALUE *argv, VALUE self) {
  std::vector< std::string > *arg1 = (std::vector< std::string > *) 0 ;
  std::vector< std::string >::difference_type arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
...
/*
  Document-method: Mylib::Stl::StdVecString.at
...
*/
SWIGINTERN VALUE
_wrap_StdVecString_at(int argc, VALUE *argv, VALUE self) {
  std::vector< std::string > *arg1 = (std::vector< std::string > *) 0 ;
  std::vector< std::string >::difference_type arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
...
/*
  Document-method: Mylib::Stl::StdVecString.[]
...
*/
SWIGINTERN VALUE
_wrap_StdVecString___getitem____SWIG_0(int argc, VALUE *argv, VALUE self) {
  std::vector< std::string > *arg1 = (std::vector< std::string > *) 0 ;
  std::vector< std::string >::difference_type arg2 ;
  std::vector< std::string >::difference_type arg3 ;
  void *argp1 = 0 ;
...
SWIGINTERN VALUE
_wrap_StdVecString___getitem____SWIG_1(int argc, VALUE *argv, VALUE self) {
  std::vector< std::string > *arg1 = (std::vector< std::string > *) 0 ;
  std::vector< std::string >::difference_type arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
...
SWIGINTERN VALUE
_wrap_StdVecString___getitem____SWIG_2(int argc, VALUE *argv, VALUE self) {
  std::vector< std::string > *arg1 = (std::vector< std::string > *) 0 ;
  VALUE arg2 = (VALUE) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
...
SWIGINTERN VALUE _wrap_StdVecString___getitem__(int nargs, VALUE *args, VALUE self) {
  int argc;
  VALUE argv[4];
  int ii;
  ...
  if (argc == 2) {
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_StdVecString___getitem____SWIG_1(nargs, args, self);
      }
    }
  }
  if (argc == 2) {
    ...
    if (_v) {
      _v = (argv[1] != 0);
      if (_v) {
        return _wrap_StdVecString___getitem____SWIG_2(nargs, args, self);
      }
    }
  }
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        if (_v) {
          return _wrap_StdVecString___getitem____SWIG_0(nargs, args, self);
        }
      }
    }
  }
...
*/
SWIGINTERN VALUE
_wrap_StdVecString___setitem____SWIG_0(int argc, VALUE *argv, VALUE self) {
  std::vector< std::string > *arg1 = (std::vector< std::string > *) 0 ;
  std::vector< std::string >::difference_type arg2 ;
...
SWIGINTERN VALUE
_wrap_StdVecString___setitem____SWIG_1(int argc, VALUE *argv, VALUE self) {
  std::vector< std::string > *arg1 = (std::vector< std::string > *) 0 ;
  std::vector< std::string >::difference_type arg2 ;
  std::vector< std::string >::difference_type arg3 ;
...
SWIGINTERN VALUE _wrap_StdVecString___setitem__(int nargs, VALUE *args, VALUE self) {
  int argc;
  VALUE argv[5];
  int ii;
  ...
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        _v = SWIG_CheckState(res);
        if (_v) {
          return _wrap_StdVecString___setitem____SWIG_0(nargs, args, self);
        }
      }
    }
  }
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        if (_v) {
          ...
          _v = SWIG_CheckState(res);
          if (_v) {
            return _wrap_StdVecString___setitem____SWIG_1(nargs, args, self);
          }
        }
      }
    }
...
/*
  Document-method: Mylib::Stl::StdVecString.reject!

  call-seq:
    reject! -> StdVecString

Iterate thru each element in the StdVecString and reject those that fail a condition.  A block must be provided.  StdVecString is modified in place.
*/
SWIGINTERN VALUE
_wrap_StdVecString_rejectN___(int argc, VALUE *argv, VALUE self) {
  std::vector< std::string > *arg1 = (std::vector< std::string > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  std::vector< std::string,std::allocator< std::string > > *result = 0 ;
...
/*
  Document-method: Mylib::Stl::StdVecString.pop

  call-seq:
    pop -> VALUE

Remove and return element at the end of the StdVecString.
*/
SWIGINTERN VALUE
_wrap_StdVecString_pop(int argc, VALUE *argv, VALUE self) {
  std::vector< std::string > *arg1 = (std::vector< std::string > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  VALUE result;
...
/*
  Document-method: Mylib::Stl::StdVecString.push

  call-seq:
    push(e) -> std::vector< std::string >::value_type const

Add an element at the end of the StdVecString.
*/
SWIGINTERN VALUE
_wrap_StdVecString_push(int argc, VALUE *argv, VALUE self) {
  std::vector< std::string > *arg1 = (std::vector< std::string > *) 0 ;
  std::vector< std::string >::value_type *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
...
Iterate thru each element in the StdVecString and reject those that fail a condition returning a new StdVecString.  A block must be provided.
*/
SWIGINTERN VALUE
_wrap_StdVecString_reject(int argc, VALUE *argv, VALUE self) {
  std::vector< std::string > *arg1 = (std::vector< std::string > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  std::vector< std::string,std::allocator< std::string > > *result = 0 ;
...
/*
  Document-method: Mylib::Stl::StdVecString.shift

  call-seq:
    shift -> VALUE

Remove and return element at the beginning of the StdVecString.
*/
SWIGINTERN VALUE
_wrap_StdVecString_shift(int argc, VALUE *argv, VALUE self) {
  std::vector< std::string > *arg1 = (std::vector< std::string > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  VALUE result;
...
/*
  Document-method: Mylib::Stl::StdVecString.insert

  call-seq:
    insert(pos, argc) -> StdVecString
    insert(pos, x) -> std::vector< std::string >::iterator
    insert(pos, n, x)

Insert one or more new elements in the StdVecString.
*/
SWIGINTERN VALUE
_wrap_StdVecString_insert__SWIG_0(int argc, VALUE *argv, VALUE self) {
  std::vector< std::string > *arg1 = (std::vector< std::string > *) 0 ;
  std::vector< std::string >::difference_type arg2 ;
  int arg3 ;
  VALUE *arg4 = (VALUE *) 0 ;
...
/*
  Document-method: Mylib::Stl::StdVecString.unshift

  call-seq:
    unshift(argc) -> StdVecString

Add one or more elements at the beginning of the StdVecString.
*/
SWIGINTERN VALUE
_wrap_StdVecString_unshift(int argc, VALUE *argv, VALUE self) {
  std::vector< std::string > *arg1 = (std::vector< std::string > *) 0 ;
  int arg2 ;
  VALUE *arg3 = (VALUE *) 0 ;
  void *arg4 = 0 ;
...
SWIGINTERN VALUE
_wrap_new_StdVecString__SWIG_0(int argc, VALUE *argv, VALUE self) {
...
SWIGINTERN VALUE
_wrap_new_StdVecString__SWIG_1(int argc, VALUE *argv, VALUE self) {
...
/*
  Document-method: Mylib::Stl::StdVecString.empty?

  call-seq:
    empty? -> bool

Check if the StdVecString is empty or not.
*/
SWIGINTERN VALUE
_wrap_StdVecString_emptyq___(int argc, VALUE *argv, VALUE self) {
  std::vector< std::string > *arg1 = (std::vector< std::string > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  bool result;
...
/*
  Document-method: Mylib::Stl::StdVecString.size

  call-seq:
    size -> std::vector< std::string >::size_type

Size or Length of the StdVecString.
*/
SWIGINTERN VALUE
_wrap_StdVecString_size(int argc, VALUE *argv, VALUE self) {
  std::vector< std::string > *arg1 = (std::vector< std::string > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
...
SWIGINTERN VALUE
_wrap_StdVecString_swap(int argc, VALUE *argv, VALUE self) {
  std::vector< std::string > *arg1 = (std::vector< std::string > *) 0 ;
...
/*
  Document-method: Mylib::Stl::StdVecString.begin

  call-seq:
    begin -> std::vector< std::string >::iterator

Return an iterator to the beginning of the StdVecString.
*/
SWIGINTERN VALUE
_wrap_StdVecString_begin(int argc, VALUE *argv, VALUE self) {
  std::vector< std::string > *arg1 = (std::vector< std::string > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
...
/*
  Document-method: Mylib::Stl::StdVecString.end

  call-seq:
    end -> std::vector< std::string >::iterator

Return an iterator to past the end of the StdVecString.
*/
SWIGINTERN VALUE
_wrap_StdVecString_end(int argc, VALUE *argv, VALUE self) {
  std::vector< std::string > *arg1 = (std::vector< std::string > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  std::vector< std::string >::iterator result;
...
/*
  Document-method: Mylib::Stl::StdVecString.rbegin

  call-seq:
    rbegin -> std::vector< std::string >::reverse_iterator

Return a reverse iterator to the beginning (the end) of the StdVecString.
*/
SWIGINTERN VALUE
_wrap_StdVecString_rbegin(int argc, VALUE *argv, VALUE self) {
  std::vector< std::string > *arg1 = (std::vector< std::string > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
...
/*
  Document-method: Mylib::Stl::StdVecString.rend

  call-seq:
    rend -> std::vector< std::string >::reverse_iterator

Return a reverse iterator to past the end (past the beginning) of the StdVecString.
*/
SWIGINTERN VALUE
_wrap_StdVecString_rend(int argc, VALUE *argv, VALUE self) {
  std::vector< std::string > *arg1 = (std::vector< std::string > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  std::vector< std::string >::reverse_iterator result;
...
/*
  Document-method: Mylib::Stl::StdVecString.clear

  call-seq:
    clear

Clear StdVecString contents.
*/
SWIGINTERN VALUE
_wrap_StdVecString_clear(int argc, VALUE *argv, VALUE self) {
  std::vector< std::string > *arg1 = (std::vector< std::string > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
...
SWIGINTERN VALUE
_wrap_StdVecString_get_allocator(int argc, VALUE *argv, VALUE self) {
  std::vector< std::string > *arg1 = (std::vector< std::string > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
...
SWIGINTERN VALUE
_wrap_new_StdVecString__SWIG_2(int argc, VALUE *argv, VALUE self) {
...
/*
  Document-method: Mylib::Stl::StdVecString.resize

  call-seq:
    resize(new_size)
    resize(new_size, x)

Resize the size of the StdVecString.
*/
SWIGINTERN VALUE
_wrap_StdVecString_resize__SWIG_0(int argc, VALUE *argv, VALUE self) {
  std::vector< std::string > *arg1 = (std::vector< std::string > *) 0 ;
...
/*
  Document-method: Mylib::Stl::StdVecString.erase

  call-seq:
    erase(pos) -> std::vector< std::string >::iterator
    erase(first, last) -> std::vector< std::string >::iterator

Delete a portion of the StdVecString.
*/
SWIGINTERN VALUE
_wrap_StdVecString_erase__SWIG_0(int argc, VALUE *argv, VALUE self) {
  std::vector< std::string > *arg1 = (std::vector< std::string > *) 0 ;
...
SWIGINTERN VALUE
_wrap_StdVecString_erase__SWIG_1(int argc, VALUE *argv, VALUE self) {
  std::vector< std::string > *arg1 = (std::vector< std::string > *) 0 ;
  std::vector< std::string >::iterator arg2 ;
...
SWIGINTERN VALUE _wrap_StdVecString_erase(int nargs, VALUE *args, VALUE self) {
  int argc;
  VALUE argv[4];
  int ii;
  ...
  if (argc == 2) {
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_StdVecString_erase__SWIG_0(nargs, args, self);
      }
    }
  }
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        _v = (SWIG_IsOK(res) && iter && (dynamic_cast<swig::Iterator_T<std::vector< std::string >::iterator > *>(iter) != 0));
        if (_v) {
          return _wrap_StdVecString_erase__SWIG_1(nargs, args, self);
        }
      }
    }
  }
...
SWIGINTERN VALUE
_wrap_StdVecString_allocate(VALUE self) {
#else
  SWIGINTERN VALUE
  _wrap_StdVecString_allocate(int argc, VALUE *argv, VALUE self) {
#endif
...
SWIGINTERN VALUE
_wrap_new_StdVecString__SWIG_3(int argc, VALUE *argv, VALUE self) {
  std::vector< std::string >::size_type arg1 ;
  std::vector< std::string >::value_type *arg2 = 0 ;
  size_t val1 ;
  int ecode1 = 0 ;
...
SWIGINTERN VALUE _wrap_new_StdVecString(int nargs, VALUE *args, VALUE self) {
  int argc;
  VALUE argv[2];
  int ii;
  ...
  if (argc == 0) {
    return _wrap_new_StdVecString__SWIG_0(nargs, args, self);
  }
  if (argc == 1) {
    int _v;
    {
    ...
    if (_v) {
      return _wrap_new_StdVecString__SWIG_2(nargs, args, self);
    }
  }
  if (argc == 1) {
    int _v;
    ...
    _v = SWIG_CheckState(res);
    if (_v) {
      return _wrap_new_StdVecString__SWIG_1(nargs, args, self);
    }
  }
  if (argc == 2) {
    int _v;
    ...
    if (_v) {
      ...
      _v = SWIG_CheckState(res);
      if (_v) {
        return _wrap_new_StdVecString__SWIG_3(nargs, args, self);
      }
    }
  }
  
fail:
  Ruby_Format_OverloadedError( argc, 2, "StdVecString.new", 
    "    StdVecString.new()\n"
    "    StdVecString.new(std::vector< std::string > const &)\n"
    "    StdVecString.new(std::vector< std::string >::size_type size)\n"
    "    StdVecString.new(std::vector< std::string >::size_type size, std::vector< std::string >::value_type const &value)\n");
...
/*
  Document-method: Mylib::Stl::StdVecString.front

  call-seq:
    front -> std::vector< std::string >::value_type const &

Return the first element in StdVecString.
*/
SWIGINTERN VALUE
_wrap_StdVecString_front(int argc, VALUE *argv, VALUE self) {
  std::vector< std::string > *arg1 = (std::vector< std::string > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
...
/*
  Document-method: Mylib::Stl::StdVecString.back

  call-seq:
    back -> std::vector< std::string >::value_type const &

Return the last element in StdVecString.
*/
SWIGINTERN VALUE
_wrap_StdVecString_back(int argc, VALUE *argv, VALUE self) {
  std::vector< std::string > *arg1 = (std::vector< std::string > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  std::vector< std::string >::value_type *result = 0 ;
...
/*
  Document-method: Mylib::Stl::StdVecString.assign

  call-seq:
    assign(n, x)

Assign a new StdVecString or portion of it.
*/
SWIGINTERN VALUE
_wrap_StdVecString_assign(int argc, VALUE *argv, VALUE self) {
  std::vector< std::string > *arg1 = (std::vector< std::string > *) 0 ;
  std::vector< std::string >::size_type arg2 ;
  std::vector< std::string >::value_type *arg3 = 0 ;
  void *argp1 = 0 ;
...
*/
SWIGINTERN VALUE
_wrap_StdVecString_resize__SWIG_1(int argc, VALUE *argv, VALUE self) {
  std::vector< std::string > *arg1 = (std::vector< std::string > *) 0 ;
  std::vector< std::string >::size_type arg2 ;
  std::vector< std::string >::value_type *arg3 = 0 ;
  void *argp1 = 0 ;
...
SWIGINTERN VALUE _wrap_StdVecString_resize(int nargs, VALUE *args, VALUE self) {
  int argc;
  VALUE argv[4];
  int ii;
  ...
  if (argc == 2) {
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_StdVecString_resize__SWIG_0(nargs, args, self);
      }
    }
  }
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        _v = SWIG_CheckState(res);
        if (_v) {
          return _wrap_StdVecString_resize__SWIG_1(nargs, args, self);
        }
      }
    }
  }
...
fail:
  Ruby_Format_OverloadedError( argc, 4, "StdVecString.resize", 
    "    void StdVecString.resize(std::vector< std::string >::size_type new_size)\n"
    "    void StdVecString.resize(std::vector< std::string >::size_type new_size, std::vector< std::string >::value_type const &x)\n");
...
*/
SWIGINTERN VALUE
_wrap_StdVecString_insert__SWIG_1(int argc, VALUE *argv, VALUE self) {
  std::vector< std::string > *arg1 = (std::vector< std::string > *) 0 ;
  std::vector< std::string >::iterator arg2 ;
  std::vector< std::string >::value_type *arg3 = 0 ;
  void *argp1 = 0 ;
...
SWIGINTERN VALUE
_wrap_StdVecString_insert__SWIG_2(int argc, VALUE *argv, VALUE self) {
  std::vector< std::string > *arg1 = (std::vector< std::string > *) 0 ;
  std::vector< std::string >::iterator arg2 ;
...
SWIGINTERN VALUE _wrap_StdVecString_insert(int nargs, VALUE *args, VALUE self) {
  int argc;
  VALUE argv[5];
  int ii;
  ...
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        _v = SWIG_CheckState(res);
        if (_v) {
          return _wrap_StdVecString_insert__SWIG_1(nargs, args, self);
        }
      }
    }
  }
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        if (_v) {
          if (argc <= 3) {
            return _wrap_StdVecString_insert__SWIG_0(nargs, args, self);
          }
          return _wrap_StdVecString_insert__SWIG_0(nargs, args, self);
        }
      }
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        if (_v) {
          ...
          _v = SWIG_CheckState(res);
          if (_v) {
            return _wrap_StdVecString_insert__SWIG_2(nargs, args, self);
          }
        }
      }
    }
...
/*
  Document-method: Mylib::Stl::StdVecString.reserve

  call-seq:
    reserve(n)

Reserve memory in the StdVecString for a number of elements.
*/
SWIGINTERN VALUE
_wrap_StdVecString_reserve(int argc, VALUE *argv, VALUE self) {
  std::vector< std::string > *arg1 = (std::vector< std::string > *) 0 ;
  std::vector< std::string >::size_type arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
...
/*
  Document-method: Mylib::Stl::StdVecString.capacity

  call-seq:
    capacity -> std::vector< std::string >::size_type

Reserved capacity of the StdVecString.
*/
SWIGINTERN VALUE
_wrap_StdVecString_capacity(int argc, VALUE *argv, VALUE self) {
  std::vector< std::string > *arg1 = (std::vector< std::string > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  std::vector< std::string >::size_type result;
...
SWIGINTERN VALUE
_wrap_StdVecString_map_bang(int argc, VALUE *argv, VALUE self) {
  std::vector< std::string > *arg1 = (std::vector< std::string > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  std::vector< std::string,std::allocator< std::string > > *result = 0 ;
...
/*
  Document-method: Mylib::Stl::StdVecString.__delete__
...
*/
SWIGINTERN VALUE
_wrap_StdVecString___delete__(int argc, VALUE *argv, VALUE self) {
  std::vector< std::string > *arg1 = (std::vector< std::string > *) 0 ;
  std::string *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
...
static swig_class SwigClassStdVecVecString;


/*
  Document-method: Mylib::Stl::StdVecVecString.dup
...
*/
SWIGINTERN VALUE
_wrap_StdVecVecString_dup(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__allocatorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > > *","dup", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< std::string > > * >(argp1);
  result = (std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > > *)std_vector_Sl_std_vector_Sl_std_string_Sg__Sg__dup(arg1);
  vresult = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_std__vectorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__allocatorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t, SWIG_POINTER_OWN |  0 );
  return vresult;
fail:
  return Qnil;
}
...
/*
  Document-method: Mylib::Stl::StdVecVecString.inspect
...
*/
SWIGINTERN VALUE
_wrap_StdVecVecString_inspect(int argc, VALUE *argv, VALUE self) {
  std::vector< std::vector< std::string > > *arg1 = (std::vector< std::vector< std::string > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  VALUE result;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__allocatorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > > *","inspect", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< std::string > > * >(argp1);
  result = (VALUE)std_vector_Sl_std_vector_Sl_std_string_Sg__Sg__inspect(arg1);
  vresult = result;
  return vresult;
fail:
  return Qnil;
...
/*
  Document-method: Mylib::Stl::StdVecVecString.to_a

  call-seq:
    to_a -> VALUE

Convert StdVecVecString to an Array.
*/
SWIGINTERN VALUE
_wrap_StdVecVecString_to_a(int argc, VALUE *argv, VALUE self) {
  std::vector< std::vector< std::string > > *arg1 = (std::vector< std::vector< std::string > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  VALUE result;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__allocatorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > > *","to_a", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< std::string > > * >(argp1);
  result = (VALUE)std_vector_Sl_std_vector_Sl_std_string_Sg__Sg__to_a(arg1);
  vresult = result;
  return vresult;
fail:
  return Qnil;
...
/*
  Document-method: Mylib::Stl::StdVecVecString.to_s
...
*/
SWIGINTERN VALUE
_wrap_StdVecVecString_to_s(int argc, VALUE *argv, VALUE self) {
  std::vector< std::vector< std::string > > *arg1 = (std::vector< std::vector< std::string > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  VALUE result;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__allocatorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > > *","to_s", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< std::string > > * >(argp1);
  result = (VALUE)std_vector_Sl_std_vector_Sl_std_string_Sg__Sg__to_s(arg1);
  vresult = result;
  return vresult;
fail:
  return Qnil;
...
/*
  Document-method: Mylib::Stl::StdVecVecString.slice

  call-seq:
    slice(i, length) -> VALUE

Return a slice (portion of) the StdVecVecString.
*/
SWIGINTERN VALUE
_wrap_StdVecVecString_slice(int argc, VALUE *argv, VALUE self) {
  std::vector< std::vector< std::string > > *arg1 = (std::vector< std::vector< std::string > > *) 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__allocatorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > > *","slice", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< std::string > > * >(argp1);
  ecode2 = SWIG_AsVal_ptrdiff_t(argv[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > >::difference_type","slice", 2, argv[0] ));
  } 
  arg2 = static_cast< std::vector< std::vector< std::string > >::difference_type >(val2);
  ecode3 = SWIG_AsVal_ptrdiff_t(argv[1], &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > >::difference_type","slice", 3, argv[1] ));
  } 
  arg3 = static_cast< std::vector< std::vector< std::string > >::difference_type >(val3);
  try {
    result = (VALUE)std_vector_Sl_std_vector_Sl_std_string_Sg__Sg__slice(arg1,arg2,arg3);
  }
  catch(std::invalid_argument &_e) {
    SWIG_exception_fail(SWIG_ValueError, (&_e)->what());
  }
...
/*
  Document-method: Mylib::Stl::StdVecVecString.each

  call-seq:
    each -> StdVecVecString

Iterate thru each element in the StdVecVecString.  A block must be provided.
*/
SWIGINTERN VALUE
_wrap_StdVecVecString_each(int argc, VALUE *argv, VALUE self) {
  std::vector< std::vector< std::string > > *arg1 = (std::vector< std::vector< std::string > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > > *result = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__allocatorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > > *","each", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< std::string > > * >(argp1);
  result = (std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > > *)std_vector_Sl_std_vector_Sl_std_string_Sg__Sg__each(arg1);
  vresult = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_std__vectorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__allocatorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t, 0 |  0 );
  return vresult;
fail:
  return Qnil;
}
...
SWIGINTERN VALUE
_wrap_StdVecVecString___delete2__(int argc, VALUE *argv, VALUE self) {
  std::vector< std::vector< std::string > > *arg1 = (std::vector< std::vector< std::string > > *) 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__allocatorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > > *","__delete2__", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< std::string > > * >(argp1);
  {
    std::vector< std::string,std::allocator< std::string > > *ptr = (std::vector< std::string,std::allocator< std::string > > *)0;
    ...
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > >::value_type const &","__delete2__", 2, argv[0] )); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "std::vector< std::vector< std::string > >::value_type const &","__delete2__", 2, argv[0])); 
    }
    arg2 = ptr;
  }
  result = (VALUE)std_vector_Sl_std_vector_Sl_std_string_Sg__Sg____delete2__(arg1,(std::vector< std::string,std::allocator< std::string > > const &)*arg2);
  vresult = result;
  if (SWIG_IsNewObj(res2)) delete arg2;
  return vresult;
fail:
...
/*
  Document-method: Mylib::Stl::StdVecVecString.select

  call-seq:
    select -> StdVecVecString

Iterate thru each element in the StdVecVecString and select those that match a condition.  A block must be provided.
*/
SWIGINTERN VALUE
_wrap_StdVecVecString_select(int argc, VALUE *argv, VALUE self) {
  std::vector< std::vector< std::string > > *arg1 = (std::vector< std::vector< std::string > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > > *result = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__allocatorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > > *","select", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< std::string > > * >(argp1);
  result = (std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > > *)std_vector_Sl_std_vector_Sl_std_string_Sg__Sg__select(arg1);
  vresult = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_std__vectorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__allocatorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t, SWIG_POINTER_OWN |  0 );
  return vresult;
fail:
  return Qnil;
...
/*
  Document-method: Mylib::Stl::StdVecVecString.delete_at
...
*/
SWIGINTERN VALUE
_wrap_StdVecVecString_delete_at(int argc, VALUE *argv, VALUE self) {
  std::vector< std::vector< std::string > > *arg1 = (std::vector< std::vector< std::string > > *) 0 ;
  std::vector< std::vector< std::string > >::difference_type arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__allocatorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > > *","delete_at", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< std::string > > * >(argp1);
  ecode2 = SWIG_AsVal_ptrdiff_t(argv[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > >::difference_type","delete_at", 2, argv[0] ));
  } 
  arg2 = static_cast< std::vector< std::vector< std::string > >::difference_type >(val2);
  result = (VALUE)std_vector_Sl_std_vector_Sl_std_string_Sg__Sg__delete_at(arg1,arg2);
  vresult = result;
  return vresult;
fail:
  return Qnil;
...
/*
  Document-method: Mylib::Stl::StdVecVecString.at
...
*/
SWIGINTERN VALUE
_wrap_StdVecVecString_at(int argc, VALUE *argv, VALUE self) {
  std::vector< std::vector< std::string > > *arg1 = (std::vector< std::vector< std::string > > *) 0 ;
  std::vector< std::vector< std::string > >::difference_type arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__allocatorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > > const *","at", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< std::string > > * >(argp1);
  ecode2 = SWIG_AsVal_ptrdiff_t(argv[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > >::difference_type","at", 2, argv[0] ));
  } 
  arg2 = static_cast< std::vector< std::vector< std::string > >::difference_type >(val2);
  result = (VALUE)std_vector_Sl_std_vector_Sl_std_string_Sg__Sg__at((std::vector< std::vector< std::string > > const *)arg1,arg2);
  vresult = result;
  return vresult;
fail:
  return Qnil;
...
/*
  Document-method: Mylib::Stl::StdVecVecString.[]
...
*/
SWIGINTERN VALUE
_wrap_StdVecVecString___getitem____SWIG_0(int argc, VALUE *argv, VALUE self) {
  std::vector< std::vector< std::string > > *arg1 = (std::vector< std::vector< std::string > > *) 0 ;
  std::vector< std::vector< std::string > >::difference_type arg2 ;
  std::vector< std::vector< std::string > >::difference_type arg3 ;
  void *argp1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__allocatorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > > const *","__getitem__", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< std::string > > * >(argp1);
  ecode2 = SWIG_AsVal_ptrdiff_t(argv[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > >::difference_type","__getitem__", 2, argv[0] ));
  } 
  arg2 = static_cast< std::vector< std::vector< std::string > >::difference_type >(val2);
  ecode3 = SWIG_AsVal_ptrdiff_t(argv[1], &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > >::difference_type","__getitem__", 3, argv[1] ));
  } 
  arg3 = static_cast< std::vector< std::vector< std::string > >::difference_type >(val3);
  try {
    result = (VALUE)std_vector_Sl_std_vector_Sl_std_string_Sg__Sg____getitem____SWIG_0((std::vector< std::vector< std::string > > const *)arg1,arg2,arg3);
  }
  catch(std::invalid_argument &_e) {
    SWIG_exception_fail(SWIG_ValueError, (&_e)->what());
  }
...
SWIGINTERN VALUE
_wrap_StdVecVecString___getitem____SWIG_1(int argc, VALUE *argv, VALUE self) {
  std::vector< std::vector< std::string > > *arg1 = (std::vector< std::vector< std::string > > *) 0 ;
  std::vector< std::vector< std::string > >::difference_type arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  arg2 = static_cast< std::vector< std::vector< std::string > >::difference_type >(val2);
  result = (VALUE)std_vector_Sl_std_vector_Sl_std_string_Sg__Sg____getitem____SWIG_1((std::vector< std::vector< std::string > > const *)arg1,arg2);
  vresult = result;
  return vresult;
fail:
  return Qnil;
...
SWIGINTERN VALUE
_wrap_StdVecVecString___getitem____SWIG_2(int argc, VALUE *argv, VALUE self) {
  std::vector< std::vector< std::string > > *arg1 = (std::vector< std::vector< std::string > > *) 0 ;
  VALUE arg2 = (VALUE) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  arg2 = argv[0];
  try {
    result = (VALUE)std_vector_Sl_std_vector_Sl_std_string_Sg__Sg____getitem____SWIG_2((std::vector< std::vector< std::string > > const *)arg1,arg2);
  }
  catch(std::invalid_argument &_e) {
    SWIG_exception_fail(SWIG_ValueError, (&_e)->what());
  }
...
SWIGINTERN VALUE _wrap_StdVecVecString___getitem__(int nargs, VALUE *args, VALUE self) {
  int argc;
  VALUE argv[4];
  int ii;
  ...
  if (argc == 2) {
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_StdVecVecString___getitem____SWIG_1(nargs, args, self);
      }
    }
  }
  if (argc == 2) {
    ...
    if (_v) {
      _v = (argv[1] != 0);
      if (_v) {
        return _wrap_StdVecVecString___getitem____SWIG_2(nargs, args, self);
      }
    }
  }
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        if (_v) {
          return _wrap_StdVecVecString___getitem____SWIG_0(nargs, args, self);
        }
      }
    }
  }
...
fail:
  Ruby_Format_OverloadedError( argc, 4, "__getitem__", 
    "    VALUE __getitem__(std::vector< std::vector< std::string > >::difference_type i, std::vector< std::vector< std::string > >::difference_type length)\n"
    "    VALUE __getitem__(std::vector< std::vector< std::string > >::difference_type i)\n"
    "    VALUE __getitem__(VALUE i)\n");
...
*/
SWIGINTERN VALUE
_wrap_StdVecVecString___setitem____SWIG_0(int argc, VALUE *argv, VALUE self) {
  std::vector< std::vector< std::string > > *arg1 = (std::vector< std::vector< std::string > > *) 0 ;
  std::vector< std::vector< std::string > >::difference_type arg2 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__allocatorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > > *","__setitem__", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< std::string > > * >(argp1);
  ecode2 = SWIG_AsVal_ptrdiff_t(argv[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > >::difference_type","__setitem__", 2, argv[0] ));
  } 
  arg2 = static_cast< std::vector< std::vector< std::string > >::difference_type >(val2);
  {
    std::vector< std::string,std::allocator< std::string > > *ptr = (std::vector< std::string,std::allocator< std::string > > *)0;
    ...
    if (!SWIG_IsOK(res3)) {
      SWIG_exception_fail(SWIG_ArgError(res3), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > >::value_type const &","__setitem__", 3, argv[1] )); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "std::vector< std::vector< std::string > >::value_type const &","__setitem__", 3, argv[1])); 
    }
    arg3 = ptr;
  }
  try {
    result = (VALUE)std_vector_Sl_std_vector_Sl_std_string_Sg__Sg____setitem____SWIG_0(arg1,arg2,(std::vector< std::string,std::allocator< std::string > > const &)*arg3);
  }
  catch(std::invalid_argument &_e) {
    SWIG_exception_fail(SWIG_ValueError, (&_e)->what());
  }
...
SWIGINTERN VALUE
_wrap_StdVecVecString___setitem____SWIG_1(int argc, VALUE *argv, VALUE self) {
  std::vector< std::vector< std::string > > *arg1 = (std::vector< std::vector< std::string > > *) 0 ;
  std::vector< std::vector< std::string > >::difference_type arg2 ;
  std::vector< std::vector< std::string > >::difference_type arg3 ;
  ...
  ecode3 = SWIG_AsVal_ptrdiff_t(argv[1], &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > >::difference_type","__setitem__", 3, argv[1] ));
  } 
  arg3 = static_cast< std::vector< std::vector< std::string > >::difference_type >(val3);
  {
    ...
    res4 = swig::asptr(argv[2], &ptr);
    if (!SWIG_IsOK(res4)) {
      SWIG_exception_fail(SWIG_ArgError(res4), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > > const &","__setitem__", 4, argv[2] )); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > > const &","__setitem__", 4, argv[2])); 
    }
    arg4 = ptr;
  }
  try {
    result = (VALUE)std_vector_Sl_std_vector_Sl_std_string_Sg__Sg____setitem____SWIG_1(arg1,arg2,arg3,(std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > > const &)*arg4);
  }
  catch(std::invalid_argument &_e) {
    SWIG_exception_fail(SWIG_ValueError, (&_e)->what());
  }
...
SWIGINTERN VALUE _wrap_StdVecVecString___setitem__(int nargs, VALUE *args, VALUE self) {
  int argc;
  VALUE argv[5];
  int ii;
  ...
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        _v = SWIG_CheckState(res);
        if (_v) {
          return _wrap_StdVecVecString___setitem____SWIG_0(nargs, args, self);
        }
      }
    }
  }
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        if (_v) {
          ...
          _v = SWIG_CheckState(res);
          if (_v) {
            return _wrap_StdVecVecString___setitem____SWIG_1(nargs, args, self);
          }
        }
      }
    }
...
fail:
  Ruby_Format_OverloadedError( argc, 5, "__setitem__", 
    "    VALUE __setitem__(std::vector< std::vector< std::string > >::difference_type i, std::vector< std::vector< std::string > >::value_type const &x)\n"
    "    VALUE __setitem__(std::vector< std::vector< std::string > >::difference_type i, std::vector< std::vector< std::string > >::difference_type length, std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > > const &v)\n");
...
/*
  Document-method: Mylib::Stl::StdVecVecString.reject!

  call-seq:
    reject! -> StdVecVecString

Iterate thru each element in the StdVecVecString and reject those that fail a condition.  A block must be provided.  StdVecVecString is modified in place.
*/
SWIGINTERN VALUE
_wrap_StdVecVecString_rejectN___(int argc, VALUE *argv, VALUE self) {
  std::vector< std::vector< std::string > > *arg1 = (std::vector< std::vector< std::string > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > > *result = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__allocatorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > > *","reject_bang", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< std::string > > * >(argp1);
  result = (std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > > *)std_vector_Sl_std_vector_Sl_std_string_Sg__Sg__reject_bang(arg1);
  vresult = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_std__vectorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__allocatorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t, 0 |  0 );
  return vresult;
fail:
  return Qnil;
...
/*
  Document-method: Mylib::Stl::StdVecVecString.pop

  call-seq:
    pop -> VALUE

Remove and return element at the end of the StdVecVecString.
*/
SWIGINTERN VALUE
_wrap_StdVecVecString_pop(int argc, VALUE *argv, VALUE self) {
  std::vector< std::vector< std::string > > *arg1 = (std::vector< std::vector< std::string > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  VALUE result;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__allocatorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > > *","pop", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< std::string > > * >(argp1);
  result = (VALUE)std_vector_Sl_std_vector_Sl_std_string_Sg__Sg__pop(arg1);
  vresult = result;
  return vresult;
fail:
  return Qnil;
...
/*
  Document-method: Mylib::Stl::StdVecVecString.push

  call-seq:
    push(e) -> StdVecString

Add an element at the end of the StdVecVecString.
*/
SWIGINTERN VALUE
_wrap_StdVecVecString_push(int argc, VALUE *argv, VALUE self) {
  std::vector< std::vector< std::string > > *arg1 = (std::vector< std::vector< std::string > > *) 0 ;
  std::vector< std::vector< std::string > >::value_type *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__allocatorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > > *","push", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< std::string > > * >(argp1);
  {
    std::vector< std::string,std::allocator< std::string > > *ptr = (std::vector< std::string,std::allocator< std::string > > *)0;
    res2 = swig::asptr(argv[0], &ptr);
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > >::value_type const &","push", 2, argv[0] )); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "std::vector< std::vector< std::string > >::value_type const &","push", 2, argv[0])); 
    }
    arg2 = ptr;
  }
  result = std_vector_Sl_std_vector_Sl_std_string_Sg__Sg__push(arg1,(std::vector< std::string,std::allocator< std::string > > const &)*arg2);
...
Iterate thru each element in the StdVecVecString and reject those that fail a condition returning a new StdVecVecString.  A block must be provided.
*/
SWIGINTERN VALUE
_wrap_StdVecVecString_reject(int argc, VALUE *argv, VALUE self) {
  std::vector< std::vector< std::string > > *arg1 = (std::vector< std::vector< std::string > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > > *result = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__allocatorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > > *","reject", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< std::string > > * >(argp1);
  result = (std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > > *)std_vector_Sl_std_vector_Sl_std_string_Sg__Sg__reject(arg1);
  vresult = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_std__vectorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__allocatorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t, SWIG_POINTER_OWN |  0 );
  return vresult;
fail:
  return Qnil;
...
/*
  Document-method: Mylib::Stl::StdVecVecString.shift

  call-seq:
    shift -> VALUE

Remove and return element at the beginning of the StdVecVecString.
*/
SWIGINTERN VALUE
_wrap_StdVecVecString_shift(int argc, VALUE *argv, VALUE self) {
  std::vector< std::vector< std::string > > *arg1 = (std::vector< std::vector< std::string > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  VALUE result;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__allocatorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > > *","shift", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< std::string > > * >(argp1);
  result = (VALUE)std_vector_Sl_std_vector_Sl_std_string_Sg__Sg__shift(arg1);
  vresult = result;
  return vresult;
fail:
  return Qnil;
...
/*
  Document-method: Mylib::Stl::StdVecVecString.insert

  call-seq:
    insert(pos, argc) -> StdVecVecString
    insert(pos, x) -> std::vector< std::vector< std::string > >::iterator
    insert(pos, n, x)

Insert one or more new elements in the StdVecVecString.
*/
SWIGINTERN VALUE
_wrap_StdVecVecString_insert__SWIG_0(int argc, VALUE *argv, VALUE self) {
  std::vector< std::vector< std::string > > *arg1 = (std::vector< std::vector< std::string > > *) 0 ;
  std::vector< std::vector< std::string > >::difference_type arg2 ;
  int arg3 ;
  VALUE *arg4 = (VALUE *) 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__allocatorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > > *","insert", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< std::string > > * >(argp1);
  ecode2 = SWIG_AsVal_ptrdiff_t(argv[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > >::difference_type","insert", 2, argv[0] ));
  } 
  arg2 = static_cast< std::vector< std::vector< std::string > >::difference_type >(val2);
  {
    arg3 = argc - 1;
  ...
  result = (std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > > *)std_vector_Sl_std_vector_Sl_std_string_Sg__Sg__insert__SWIG_0(arg1,arg2,arg3,arg4,arg5);
  vresult = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_std__vectorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__allocatorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t, 0 |  0 );
  return vresult;
fail:
  return Qnil;
...
/*
  Document-method: Mylib::Stl::StdVecVecString.unshift

  call-seq:
    unshift(argc) -> StdVecVecString

Add one or more elements at the beginning of the StdVecVecString.
*/
SWIGINTERN VALUE
_wrap_StdVecVecString_unshift(int argc, VALUE *argv, VALUE self) {
  std::vector< std::vector< std::string > > *arg1 = (std::vector< std::vector< std::string > > *) 0 ;
  int arg2 ;
  VALUE *arg3 = (VALUE *) 0 ;
  void *arg4 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__allocatorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > > *","unshift", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< std::string > > * >(argp1);
  {
    arg2 = argc;
  ...
  result = (std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > > *)std_vector_Sl_std_vector_Sl_std_string_Sg__Sg__unshift(arg1,arg2,arg3,arg4);
  vresult = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_std__vectorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__allocatorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t, 0 |  0 );
  return vresult;
fail:
  return Qnil;
...
SWIGINTERN VALUE
_wrap_new_StdVecVecString__SWIG_0(int argc, VALUE *argv, VALUE self) {
...
SWIGINTERN VALUE
_wrap_new_StdVecVecString__SWIG_1(int argc, VALUE *argv, VALUE self) {
  ...
  }
  {
    ...
    res1 = swig::asptr(argv[0], &ptr);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string,std::allocator< std::string > > > const &","vector<(std::vector<(std::string)>)>", 1, argv[0] )); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "std::vector< std::vector< std::string,std::allocator< std::string > > > const &","vector<(std::vector<(std::string)>)>", 1, argv[0])); 
    }
    arg1 = ptr;
  }
...
/*
  Document-method: Mylib::Stl::StdVecVecString.empty?

  call-seq:
    empty? -> bool

Check if the StdVecVecString is empty or not.
*/
SWIGINTERN VALUE
_wrap_StdVecVecString_emptyq___(int argc, VALUE *argv, VALUE self) {
  std::vector< std::vector< std::string > > *arg1 = (std::vector< std::vector< std::string > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  bool result;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__allocatorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > > const *","empty", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< std::string > > * >(argp1);
...
/*
  Document-method: Mylib::Stl::StdVecVecString.size

  call-seq:
    size -> std::vector< std::vector< std::string > >::size_type

Size or Length of the StdVecVecString.
*/
SWIGINTERN VALUE
_wrap_StdVecVecString_size(int argc, VALUE *argv, VALUE self) {
  std::vector< std::vector< std::string > > *arg1 = (std::vector< std::vector< std::string > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__allocatorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > > const *","size", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< std::string > > * >(argp1);
...
SWIGINTERN VALUE
_wrap_StdVecVecString_swap(int argc, VALUE *argv, VALUE self) {
  std::vector< std::vector< std::string > > *arg1 = (std::vector< std::vector< std::string > > *) 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__allocatorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > > *","swap", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< std::string > > * >(argp1);
  res2 = SWIG_ConvertPtr(argv[0], &argp2, SWIGTYPE_p_std__vectorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__allocatorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t,  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string,std::allocator< std::string > > > &","swap", 2, argv[0] )); 
  }
  if (!argp2) {
    SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "std::vector< std::vector< std::string,std::allocator< std::string > > > &","swap", 2, argv[0])); 
  }
...
/*
  Document-method: Mylib::Stl::StdVecVecString.begin

  call-seq:
    begin -> std::vector< std::vector< std::string > >::iterator

Return an iterator to the beginning of the StdVecVecString.
*/
SWIGINTERN VALUE
_wrap_StdVecVecString_begin(int argc, VALUE *argv, VALUE self) {
  std::vector< std::vector< std::string > > *arg1 = (std::vector< std::vector< std::string > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__allocatorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > > *","begin", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< std::string > > * >(argp1);
  result = (arg1)->begin();
  vresult = SWIG_NewPointerObj(swig::make_nonconst_iterator(static_cast< const std::vector< std::vector< std::string > >::iterator & >(result),
      self),
    swig::Iterator::descriptor(),SWIG_POINTER_OWN);
  return vresult;
fail:
...
/*
  Document-method: Mylib::Stl::StdVecVecString.end

  call-seq:
    end -> std::vector< std::vector< std::string > >::iterator

Return an iterator to past the end of the StdVecVecString.
*/
SWIGINTERN VALUE
_wrap_StdVecVecString_end(int argc, VALUE *argv, VALUE self) {
  std::vector< std::vector< std::string > > *arg1 = (std::vector< std::vector< std::string > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  std::vector< std::vector< std::string > >::iterator result;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__allocatorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > > *","end", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< std::string > > * >(argp1);
  result = (arg1)->end();
  vresult = SWIG_NewPointerObj(swig::make_nonconst_iterator(static_cast< const std::vector< std::vector< std::string > >::iterator & >(result),
...
/*
  Document-method: Mylib::Stl::StdVecVecString.rbegin

  call-seq:
    rbegin -> std::vector< std::vector< std::string > >::reverse_iterator

Return a reverse iterator to the beginning (the end) of the StdVecVecString.
*/
SWIGINTERN VALUE
_wrap_StdVecVecString_rbegin(int argc, VALUE *argv, VALUE self) {
  std::vector< std::vector< std::string > > *arg1 = (std::vector< std::vector< std::string > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__allocatorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > > *","rbegin", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< std::string > > * >(argp1);
  result = (arg1)->rbegin();
  vresult = SWIG_NewPointerObj(swig::make_nonconst_iterator(static_cast< const std::vector< std::vector< std::string > >::reverse_iterator & >(result),
      self),
    swig::Iterator::descriptor(),SWIG_POINTER_OWN);
  return vresult;
fail:
...
/*
  Document-method: Mylib::Stl::StdVecVecString.rend

  call-seq:
    rend -> std::vector< std::vector< std::string > >::reverse_iterator

Return a reverse iterator to past the end (past the beginning) of the StdVecVecString.
*/
SWIGINTERN VALUE
_wrap_StdVecVecString_rend(int argc, VALUE *argv, VALUE self) {
  std::vector< std::vector< std::string > > *arg1 = (std::vector< std::vector< std::string > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  std::vector< std::vector< std::string > >::reverse_iterator result;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__allocatorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > > *","rend", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< std::string > > * >(argp1);
  result = (arg1)->rend();
  vresult = SWIG_NewPointerObj(swig::make_nonconst_iterator(static_cast< const std::vector< std::vector< std::string > >::reverse_iterator & >(result),
...
/*
  Document-method: Mylib::Stl::StdVecVecString.clear

  call-seq:
    clear

Clear StdVecVecString contents.
*/
SWIGINTERN VALUE
_wrap_StdVecVecString_clear(int argc, VALUE *argv, VALUE self) {
  std::vector< std::vector< std::string > > *arg1 = (std::vector< std::vector< std::string > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__allocatorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > > *","clear", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< std::string > > * >(argp1);
  (arg1)->clear();
  return Qnil;
...
SWIGINTERN VALUE
_wrap_StdVecVecString_get_allocator(int argc, VALUE *argv, VALUE self) {
  std::vector< std::vector< std::string > > *arg1 = (std::vector< std::vector< std::string > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__allocatorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > > const *","get_allocator", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< std::string > > * >(argp1);
  result = ((std::vector< std::vector< std::string > > const *)arg1)->get_allocator();
  vresult = SWIG_NewPointerObj((new std::vector< std::vector< std::string > >::allocator_type(static_cast< const std::vector< std::vector< std::string > >::allocator_type& >(result))), SWIGTYPE_p_std__allocatorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_t, SWIG_POINTER_OWN |  0 );
  return vresult;
fail:
  return Qnil;
}
...
SWIGINTERN VALUE
_wrap_new_StdVecVecString__SWIG_2(int argc, VALUE *argv, VALUE self) {
  ...
  ecode1 = SWIG_AsVal_size_t(argv[0], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > >::size_type","vector<(std::vector<(std::string)>)>", 1, argv[0] ));
  } 
...
/*
  Document-method: Mylib::Stl::StdVecVecString.resize

  call-seq:
    resize(new_size)
    resize(new_size, x)

Resize the size of the StdVecVecString.
*/
SWIGINTERN VALUE
_wrap_StdVecVecString_resize__SWIG_0(int argc, VALUE *argv, VALUE self) {
  std::vector< std::vector< std::string > > *arg1 = (std::vector< std::vector< std::string > > *) 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__allocatorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > > *","resize", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< std::string > > * >(argp1);
  ecode2 = SWIG_AsVal_size_t(argv[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > >::size_type","resize", 2, argv[0] ));
  } 
...
/*
  Document-method: Mylib::Stl::StdVecVecString.erase

  call-seq:
    erase(pos) -> std::vector< std::vector< std::string > >::iterator
    erase(first, last) -> std::vector< std::vector< std::string > >::iterator

Delete a portion of the StdVecVecString.
*/
SWIGINTERN VALUE
_wrap_StdVecVecString_erase__SWIG_0(int argc, VALUE *argv, VALUE self) {
  std::vector< std::vector< std::string > > *arg1 = (std::vector< std::vector< std::string > > *) 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__allocatorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > > *","erase", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< std::string > > * >(argp1);
  res2 = SWIG_ConvertPtr(argv[0], SWIG_as_voidptrptr(&iter2), swig::Iterator::descriptor(), 0);
  if (!SWIG_IsOK(res2) || !iter2) {
    SWIG_exception_fail(SWIG_ArgError(SWIG_TypeError), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > >::iterator","erase", 2, argv[0] ));
  } else {
    swig::Iterator_T<std::vector< std::vector< std::string > >::iterator > *iter_t = dynamic_cast<swig::Iterator_T<std::vector< std::vector< std::string > >::iterator > *>(iter2);
    if (iter_t) {
      arg2 = iter_t->get_current();
    } else {
      SWIG_exception_fail(SWIG_ArgError(SWIG_TypeError), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > >::iterator","erase", 2, argv[0] ));
...
SWIGINTERN VALUE
_wrap_StdVecVecString_erase__SWIG_1(int argc, VALUE *argv, VALUE self) {
  std::vector< std::vector< std::string > > *arg1 = (std::vector< std::vector< std::string > > *) 0 ;
  std::vector< std::vector< std::string > >::iterator arg2 ;
  ...
  res3 = SWIG_ConvertPtr(argv[1], SWIG_as_voidptrptr(&iter3), swig::Iterator::descriptor(), 0);
  if (!SWIG_IsOK(res3) || !iter3) {
    SWIG_exception_fail(SWIG_ArgError(SWIG_TypeError), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > >::iterator","erase", 3, argv[1] ));
  } else {
    swig::Iterator_T<std::vector< std::vector< std::string > >::iterator > *iter_t = dynamic_cast<swig::Iterator_T<std::vector< std::vector< std::string > >::iterator > *>(iter3);
    if (iter_t) {
      arg3 = iter_t->get_current();
    } else {
      SWIG_exception_fail(SWIG_ArgError(SWIG_TypeError), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > >::iterator","erase", 3, argv[1] ));
...
SWIGINTERN VALUE _wrap_StdVecVecString_erase(int nargs, VALUE *args, VALUE self) {
  int argc;
  VALUE argv[4];
  int ii;
  ...
  if (argc == 2) {
    ...
    if (_v) {
      ...
      int res = SWIG_ConvertPtr(argv[1], SWIG_as_voidptrptr(&iter), 
        swig::Iterator::descriptor(), 0);
      _v = (SWIG_IsOK(res) && iter && (dynamic_cast<swig::Iterator_T<std::vector< std::vector< std::string > >::iterator > *>(iter) != 0));
      if (_v) {
        return _wrap_StdVecVecString_erase__SWIG_0(nargs, args, self);
      }
    }
  }
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        _v = (SWIG_IsOK(res) && iter && (dynamic_cast<swig::Iterator_T<std::vector< std::vector< std::string > >::iterator > *>(iter) != 0));
        if (_v) {
          return _wrap_StdVecVecString_erase__SWIG_1(nargs, args, self);
        }
      }
    }
  }
...
fail:
  Ruby_Format_OverloadedError( argc, 4, "erase", 
    "    std::vector< std::vector< std::string > >::iterator erase(std::vector< std::vector< std::string > >::iterator pos)\n"
    "    std::vector< std::vector< std::string > >::iterator erase(std::vector< std::vector< std::string > >::iterator first, std::vector< std::vector< std::string > >::iterator last)\n");
...
#ifdef HAVE_RB_DEFINE_ALLOC_FUNC
SWIGINTERN VALUE
_wrap_StdVecVecString_allocate(VALUE self) {
#else
  SWIGINTERN VALUE
  _wrap_StdVecVecString_allocate(int argc, VALUE *argv, VALUE self) {
#endif
    
    
    VALUE vresult = SWIG_NewClassInstance(self, SWIGTYPE_p_std__vectorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__allocatorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t);
#ifndef HAVE_RB_DEFINE_ALLOC_FUNC
    rb_obj_call_init(vresult, argc, argv);
#endif
    return vresult;
...
SWIGINTERN VALUE
_wrap_new_StdVecVecString__SWIG_3(int argc, VALUE *argv, VALUE self) {
  std::vector< std::vector< std::string > >::size_type arg1 ;
  std::vector< std::vector< std::string > >::value_type *arg2 = 0 ;
  size_t val1 ;
  int ecode1 = 0 ;
  ...
  arg1 = static_cast< std::vector< std::vector< std::string > >::size_type >(val1);
  {
    ...
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > >::value_type const &","vector<(std::vector<(std::string)>)>", 2, argv[1] )); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "std::vector< std::vector< std::string > >::value_type const &","vector<(std::vector<(std::string)>)>", 2, argv[1])); 
    }
    arg2 = ptr;
  }
...
SWIGINTERN VALUE _wrap_new_StdVecVecString(int nargs, VALUE *args, VALUE self) {
  int argc;
  VALUE argv[2];
  int ii;
  ...
  if (argc == 0) {
    return _wrap_new_StdVecVecString__SWIG_0(nargs, args, self);
  }
  if (argc == 1) {
    int _v;
    {
    ...
    if (_v) {
      return _wrap_new_StdVecVecString__SWIG_2(nargs, args, self);
    }
  }
  if (argc == 1) {
    int _v;
    ...
    _v = SWIG_CheckState(res);
    if (_v) {
      return _wrap_new_StdVecVecString__SWIG_1(nargs, args, self);
    }
  }
  if (argc == 2) {
    int _v;
    ...
    if (_v) {
      ...
      _v = SWIG_CheckState(res);
      if (_v) {
        return _wrap_new_StdVecVecString__SWIG_3(nargs, args, self);
      }
    }
  }
  
fail:
  Ruby_Format_OverloadedError( argc, 2, "StdVecVecString.new", 
    "    StdVecVecString.new()\n"
    "    StdVecVecString.new(std::vector< std::vector< std::string,std::allocator< std::string > > > const &)\n"
    "    StdVecVecString.new(std::vector< std::vector< std::string > >::size_type size)\n"
    "    StdVecVecString.new(std::vector< std::vector< std::string > >::size_type size, std::vector< std::vector< std::string > >::value_type const &value)\n");
...
/*
  Document-method: Mylib::Stl::StdVecVecString.front

  call-seq:
    front -> StdVecString

Return the first element in StdVecVecString.
*/
SWIGINTERN VALUE
_wrap_StdVecVecString_front(int argc, VALUE *argv, VALUE self) {
  std::vector< std::vector< std::string > > *arg1 = (std::vector< std::vector< std::string > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__allocatorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > > const *","front", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< std::string > > * >(argp1);
...
/*
  Document-method: Mylib::Stl::StdVecVecString.back

  call-seq:
    back -> StdVecString

Return the last element in StdVecVecString.
*/
SWIGINTERN VALUE
_wrap_StdVecVecString_back(int argc, VALUE *argv, VALUE self) {
  std::vector< std::vector< std::string > > *arg1 = (std::vector< std::vector< std::string > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  std::vector< std::vector< std::string > >::value_type *result = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__allocatorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > > const *","back", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< std::string > > * >(argp1);
...
/*
  Document-method: Mylib::Stl::StdVecVecString.assign

  call-seq:
    assign(n, x)

Assign a new StdVecVecString or portion of it.
*/
SWIGINTERN VALUE
_wrap_StdVecVecString_assign(int argc, VALUE *argv, VALUE self) {
  std::vector< std::vector< std::string > > *arg1 = (std::vector< std::vector< std::string > > *) 0 ;
  std::vector< std::vector< std::string > >::size_type arg2 ;
  std::vector< std::vector< std::string > >::value_type *arg3 = 0 ;
  void *argp1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__allocatorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > > *","assign", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< std::string > > * >(argp1);
  ecode2 = SWIG_AsVal_size_t(argv[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > >::size_type","assign", 2, argv[0] ));
  } 
  arg2 = static_cast< std::vector< std::vector< std::string > >::size_type >(val2);
  {
    std::vector< std::string,std::allocator< std::string > > *ptr = (std::vector< std::string,std::allocator< std::string > > *)0;
    res3 = swig::asptr(argv[1], &ptr);
    if (!SWIG_IsOK(res3)) {
      SWIG_exception_fail(SWIG_ArgError(res3), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > >::value_type const &","assign", 3, argv[1] )); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "std::vector< std::vector< std::string > >::value_type const &","assign", 3, argv[1])); 
    }
    arg3 = ptr;
  }
...
*/
SWIGINTERN VALUE
_wrap_StdVecVecString_resize__SWIG_1(int argc, VALUE *argv, VALUE self) {
  std::vector< std::vector< std::string > > *arg1 = (std::vector< std::vector< std::string > > *) 0 ;
  std::vector< std::vector< std::string > >::size_type arg2 ;
  std::vector< std::vector< std::string > >::value_type *arg3 = 0 ;
  void *argp1 = 0 ;
  ...
  arg2 = static_cast< std::vector< std::vector< std::string > >::size_type >(val2);
  {
    ...
    res3 = swig::asptr(argv[1], &ptr);
    if (!SWIG_IsOK(res3)) {
      SWIG_exception_fail(SWIG_ArgError(res3), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > >::value_type const &","resize", 3, argv[1] )); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "std::vector< std::vector< std::string > >::value_type const &","resize", 3, argv[1])); 
    }
    arg3 = ptr;
  }
...
SWIGINTERN VALUE _wrap_StdVecVecString_resize(int nargs, VALUE *args, VALUE self) {
  int argc;
  VALUE argv[4];
  int ii;
  ...
  if (argc == 2) {
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_StdVecVecString_resize__SWIG_0(nargs, args, self);
      }
    }
  }
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        _v = SWIG_CheckState(res);
        if (_v) {
          return _wrap_StdVecVecString_resize__SWIG_1(nargs, args, self);
        }
      }
    }
  }
...
fail:
  Ruby_Format_OverloadedError( argc, 4, "StdVecVecString.resize", 
    "    void StdVecVecString.resize(std::vector< std::vector< std::string > >::size_type new_size)\n"
    "    void StdVecVecString.resize(std::vector< std::vector< std::string > >::size_type new_size, std::vector< std::vector< std::string > >::value_type const &x)\n");
...
*/
SWIGINTERN VALUE
_wrap_StdVecVecString_insert__SWIG_1(int argc, VALUE *argv, VALUE self) {
  std::vector< std::vector< std::string > > *arg1 = (std::vector< std::vector< std::string > > *) 0 ;
  std::vector< std::vector< std::string > >::iterator arg2 ;
  std::vector< std::vector< std::string > >::value_type *arg3 = 0 ;
  void *argp1 = 0 ;
  ...
  res2 = SWIG_ConvertPtr(argv[0], SWIG_as_voidptrptr(&iter2), swig::Iterator::descriptor(), 0);
  if (!SWIG_IsOK(res2) || !iter2) {
    SWIG_exception_fail(SWIG_ArgError(SWIG_TypeError), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > >::iterator","insert", 2, argv[0] ));
  } else {
    swig::Iterator_T<std::vector< std::vector< std::string > >::iterator > *iter_t = dynamic_cast<swig::Iterator_T<std::vector< std::vector< std::string > >::iterator > *>(iter2);
    if (iter_t) {
      arg2 = iter_t->get_current();
  ...
  }
  {
    ...
    res3 = swig::asptr(argv[1], &ptr);
    if (!SWIG_IsOK(res3)) {
      SWIG_exception_fail(SWIG_ArgError(res3), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > >::value_type const &","insert", 3, argv[1] )); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "std::vector< std::vector< std::string > >::value_type const &","insert", 3, argv[1])); 
    }
    arg3 = ptr;
  }
  result = std_vector_Sl_std_vector_Sl_std_string_Sg__Sg__insert__SWIG_1(arg1,arg2,(std::vector< std::string,std::allocator< std::string > > const &)*arg3);
  vresult = SWIG_NewPointerObj(swig::make_nonconst_iterator(static_cast< const std::vector< std::vector< std::string > >::iterator & >(result),
      self),
    swig::Iterator::descriptor(),SWIG_POINTER_OWN);
  if (SWIG_IsNewObj(res3)) delete arg3;
...
SWIGINTERN VALUE
_wrap_StdVecVecString_insert__SWIG_2(int argc, VALUE *argv, VALUE self) {
  std::vector< std::vector< std::string > > *arg1 = (std::vector< std::vector< std::string > > *) 0 ;
  std::vector< std::vector< std::string > >::iterator arg2 ;
  ...
  ecode3 = SWIG_AsVal_size_t(argv[1], &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > >::size_type","insert", 3, argv[1] ));
  } 
  arg3 = static_cast< std::vector< std::vector< std::string > >::size_type >(val3);
  {
    ...
    res4 = swig::asptr(argv[2], &ptr);
    if (!SWIG_IsOK(res4)) {
      SWIG_exception_fail(SWIG_ArgError(res4), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > >::value_type const &","insert", 4, argv[2] )); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "std::vector< std::vector< std::string > >::value_type const &","insert", 4, argv[2])); 
    }
    arg4 = ptr;
  }
  std_vector_Sl_std_vector_Sl_std_string_Sg__Sg__insert__SWIG_2(arg1,arg2,arg3,(std::vector< std::string,std::allocator< std::string > > const &)*arg4);
  if (SWIG_IsNewObj(res4)) delete arg4;
  return Qnil;
fail:
  if (SWIG_IsNewObj(res4)) delete arg4;
...
SWIGINTERN VALUE _wrap_StdVecVecString_insert(int nargs, VALUE *args, VALUE self) {
  int argc;
  VALUE argv[5];
  int ii;
  ...
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        _v = SWIG_CheckState(res);
        if (_v) {
          return _wrap_StdVecVecString_insert__SWIG_1(nargs, args, self);
        }
      }
    }
  }
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        if (_v) {
          if (argc <= 3) {
            return _wrap_StdVecVecString_insert__SWIG_0(nargs, args, self);
          }
          return _wrap_StdVecVecString_insert__SWIG_0(nargs, args, self);
        }
      }
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        if (_v) {
          ...
          _v = SWIG_CheckState(res);
          if (_v) {
            return _wrap_StdVecVecString_insert__SWIG_2(nargs, args, self);
          }
        }
      }
    }
...
fail:
  Ruby_Format_OverloadedError( argc, 5, "insert", 
    "    void insert(std::vector< std::vector< std::string > >::difference_type pos, int argc, VALUE *argv, ...)\n"
    "    void insert(std::vector< std::vector< std::string > >::iterator pos, std::vector< std::vector< std::string > >::value_type const &x)\n"
    "    void insert(std::vector< std::vector< std::string > >::iterator pos, std::vector< std::vector< std::string > >::size_type n, std::vector< std::vector< std::string > >::value_type const &x)\n");
...
/*
  Document-method: Mylib::Stl::StdVecVecString.reserve

  call-seq:
    reserve(n)

Reserve memory in the StdVecVecString for a number of elements.
*/
SWIGINTERN VALUE
_wrap_StdVecVecString_reserve(int argc, VALUE *argv, VALUE self) {
  std::vector< std::vector< std::string > > *arg1 = (std::vector< std::vector< std::string > > *) 0 ;
  std::vector< std::vector< std::string > >::size_type arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__allocatorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > > *","reserve", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< std::string > > * >(argp1);
  ecode2 = SWIG_AsVal_size_t(argv[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > >::size_type","reserve", 2, argv[0] ));
  } 
  arg2 = static_cast< std::vector< std::vector< std::string > >::size_type >(val2);
  (arg1)->reserve(arg2);
  return Qnil;
...
/*
  Document-method: Mylib::Stl::StdVecVecString.capacity

  call-seq:
    capacity -> std::vector< std::vector< std::string > >::size_type

Reserved capacity of the StdVecVecString.
*/
SWIGINTERN VALUE
_wrap_StdVecVecString_capacity(int argc, VALUE *argv, VALUE self) {
  std::vector< std::vector< std::string > > *arg1 = (std::vector< std::vector< std::string > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  std::vector< std::vector< std::string > >::size_type result;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__allocatorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string > > const *","capacity", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< std::string > > * >(argp1);
...
SWIGINTERN void
free_std_vector_Sl_std_vector_Sl_std_string_Sg__Sg_(void *self) {
    std::vector< std::vector< std::string > > *arg1 = (std::vector< std::vector< std::string > > *)self;
    delete arg1;
}
...
/*
  Document-method: Mylib::Stl::MapStringString.dup
...
/*
  Document-method: Mylib::Stl::MapStringString.delete
...
/*
  Document-method: Mylib::Stl::MapStringString.keys
...
/*
  Document-method: Mylib::Stl::MapStringString.each
...
/*
  Document-method: Mylib::Stl::MapStringString.select
...
/*
  Document-method: Mylib::Stl::MapStringString.values_at
...
/*
  Document-method: Mylib::Stl::MapStringString.each_key
...
/*
  Document-method: Mylib::Stl::MapStringString.values
...
/*
  Document-method: Mylib::Stl::MapStringString.each_value
...
/*
  Document-method: Mylib::Stl::MapStringString.[]
...
/*
  Document-method: Mylib::Stl::MapStringString.inspect
...
/*
  Document-method: Mylib::Stl::MapStringString.to_a
...
/*
  Document-method: Mylib::Stl::MapStringString.to_s
...
/*
  Document-method: Mylib::Stl::MapStringString.empty?
...
/*
  Document-method: Mylib::Stl::MapStringString.size
...
/*
  Document-method: Mylib::Stl::MapStringString.begin
...
/*
  Document-method: Mylib::Stl::MapStringString.end
...
/*
  Document-method: Mylib::Stl::MapStringString.rbegin
...
/*
  Document-method: Mylib::Stl::MapStringString.rend
...
/*
  Document-method: Mylib::Stl::MapStringString.clear
...
/*
  Document-method: Mylib::Stl::MapStringString.erase
...
/*
  Document-method: Mylib::Stl::MapStringString.find
...
SWIGINTERN void
free_std_map_Sl_std_string_Sc_std_string_Sg_(void *self) {
    std::map< std::string,std::string > *arg1 = (std::map< std::string,std::string > *)self;
    delete arg1;
}

SWIGINTERN VALUE
_wrap_vec_len(int argc, VALUE *argv, VALUE self) {
  ...
  }
  {
    ...
    res1 = swig::asptr(argv[0], &ptr);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< std::string,std::allocator< std::string > > const &","vec_len", 1, argv[0] )); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "std::vector< std::string,std::allocator< std::string > > const &","vec_len", 1, argv[0])); 
    }
    arg1 = ptr;
  }
  result = (int)vec_len((std::vector< std::string,std::allocator< std::string > > const &)*arg1);
...
SWIGINTERN VALUE
_wrap_get_hash_x(int argc, VALUE *argv, VALUE self) {
  ...
  }
  {
    ...
    res1 = swig::asptr(argv[0], &ptr);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::map< std::string,std::string,std::less< std::string >,std::allocator< std::pair< std::string const,std::string > > > const &","get_hash_x", 1, argv[0] )); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "std::map< std::string,std::string,std::less< std::string >,std::allocator< std::pair< std::string const,std::string > > > const &","get_hash_x", 1, argv[0])); 
    }
    arg1 = ptr;
  }
  result = get_hash_x((std::map< std::string,std::string,std::less< std::string >,std::allocator< std::pair< std::string const,std::string > > > const &)*arg1);
  vresult = SWIG_From_std_string(static_cast< std::string >(result));
  if (SWIG_IsNewObj(res1)) delete arg1;
  return vresult;
fail:
...
SWIGINTERN VALUE
_wrap_first_string(int argc, VALUE *argv, VALUE self) {
  ...
  }
  {
    ...
    res1 = swig::asptr(argv[0], &ptr);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > > const &","first_string", 1, argv[0] )); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > > const &","first_string", 1, argv[0])); 
    }
    arg1 = ptr;
  }
  result = first_string((std::vector< std::vector< std::string,std::allocator< std::string > >,std::allocator< std::vector< std::string,std::allocator< std::string > > > > const &)*arg1);
  vresult = SWIG_From_std_string(static_cast< std::string >(result));
  if (SWIG_IsNewObj(res1)) delete arg1;
  return vresult;
fail:
...
extern "C"
#endif
SWIGEXPORT void Init_stl(void) {
  size_t i;
  
  SWIG_InitRuntime();
  mStl = rb_define_module("Mylib");
  mStl = rb_define_module_under(mStl, "Stl");
  ...
  SwigClassGC_VALUE.klass = rb_define_class_under(mStl, "GC_VALUE", rb_cObject);
  ...
  SwigClassConstIterator.klass = rb_define_class_under(mStl, "ConstIterator", rb_cObject);
  ...
  SwigClassIterator.klass = rb_define_class_under(mStl, "Iterator", ((swig_class *) SWIGTYPE_p_swig__ConstIterator->clientdata)->klass);
  ...
  SwigClassStdVecString.klass = rb_define_class_under(mStl, "StdVecString", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_std__vectorT_std__string_std__allocatorT_std__string_t_t, (void *) &SwigClassStdVecString);
  rb_include_module(SwigClassStdVecString.klass, rb_eval_string("Enumerable"));
  rb_define_alloc_func(SwigClassStdVecString.klass, _wrap_StdVecString_allocate);
  rb_define_method(SwigClassStdVecString.klass, "initialize", VALUEFUNC(_wrap_new_StdVecString), -1);
  rb_define_method(SwigClassStdVecString.klass, "dup", VALUEFUNC(_wrap_StdVecString_dup), -1);
  rb_define_method(SwigClassStdVecString.klass, "inspect", VALUEFUNC(_wrap_StdVecString_inspect), -1);
  rb_define_method(SwigClassStdVecString.klass, "to_a", VALUEFUNC(_wrap_StdVecString_to_a), -1);
  rb_define_method(SwigClassStdVecString.klass, "to_s", VALUEFUNC(_wrap_StdVecString_to_s), -1);
  rb_define_method(SwigClassStdVecString.klass, "slice", VALUEFUNC(_wrap_StdVecString_slice), -1);
  rb_define_method(SwigClassStdVecString.klass, "each", VALUEFUNC(_wrap_StdVecString_each), -1);
  rb_define_method(SwigClassStdVecString.klass, "__delete2__", VALUEFUNC(_wrap_StdVecString___delete2__), -1);
  rb_define_method(SwigClassStdVecString.klass, "select", VALUEFUNC(_wrap_StdVecString_select), -1);
  rb_define_method(SwigClassStdVecString.klass, "delete_at", VALUEFUNC(_wrap_StdVecString_delete_at), -1);
  rb_define_method(SwigClassStdVecString.klass, "at", VALUEFUNC(_wrap_StdVecString_at), -1);
  rb_define_method(SwigClassStdVecString.klass, "[]", VALUEFUNC(_wrap_StdVecString___getitem__), -1);
  rb_define_method(SwigClassStdVecString.klass, "[]=", VALUEFUNC(_wrap_StdVecString___setitem__), -1);
  rb_define_method(SwigClassStdVecString.klass, "reject!", VALUEFUNC(_wrap_StdVecString_rejectN___), -1);
  rb_define_alias(SwigClassStdVecString.klass, "delete_if", "reject!");
  rb_define_method(SwigClassStdVecString.klass, "pop", VALUEFUNC(_wrap_StdVecString_pop), -1);
  rb_define_method(SwigClassStdVecString.klass, "push", VALUEFUNC(_wrap_StdVecString_push), -1);
  rb_define_alias(SwigClassStdVecString.klass, "<<", "push");
  rb_define_method(SwigClassStdVecString.klass, "reject", VALUEFUNC(_wrap_StdVecString_reject), -1);
  rb_define_method(SwigClassStdVecString.klass, "shift", VALUEFUNC(_wrap_StdVecString_shift), -1);
  rb_define_method(SwigClassStdVecString.klass, "unshift", VALUEFUNC(_wrap_StdVecString_unshift), -1);
  rb_define_method(SwigClassStdVecString.klass, "empty?", VALUEFUNC(_wrap_StdVecString_emptyq___), -1);
  rb_define_method(SwigClassStdVecString.klass, "size", VALUEFUNC(_wrap_StdVecString_size), -1);
  rb_define_method(SwigClassStdVecString.klass, "swap", VALUEFUNC(_wrap_StdVecString_swap), -1);
  rb_define_method(SwigClassStdVecString.klass, "begin", VALUEFUNC(_wrap_StdVecString_begin), -1);
  rb_define_method(SwigClassStdVecString.klass, "end", VALUEFUNC(_wrap_StdVecString_end), -1);
  rb_define_method(SwigClassStdVecString.klass, "rbegin", VALUEFUNC(_wrap_StdVecString_rbegin), -1);
  rb_define_method(SwigClassStdVecString.klass, "rend", VALUEFUNC(_wrap_StdVecString_rend), -1);
  rb_define_method(SwigClassStdVecString.klass, "clear", VALUEFUNC(_wrap_StdVecString_clear), -1);
  rb_define_method(SwigClassStdVecString.klass, "get_allocator", VALUEFUNC(_wrap_StdVecString_get_allocator), -1);
  rb_define_method(SwigClassStdVecString.klass, "erase", VALUEFUNC(_wrap_StdVecString_erase), -1);
  rb_define_method(SwigClassStdVecString.klass, "front", VALUEFUNC(_wrap_StdVecString_front), -1);
  rb_define_method(SwigClassStdVecString.klass, "back", VALUEFUNC(_wrap_StdVecString_back), -1);
  rb_define_method(SwigClassStdVecString.klass, "assign", VALUEFUNC(_wrap_StdVecString_assign), -1);
  rb_define_method(SwigClassStdVecString.klass, "resize", VALUEFUNC(_wrap_StdVecString_resize), -1);
  rb_define_method(SwigClassStdVecString.klass, "insert", VALUEFUNC(_wrap_StdVecString_insert), -1);
  rb_define_method(SwigClassStdVecString.klass, "reserve", VALUEFUNC(_wrap_StdVecString_reserve), -1);
  rb_define_method(SwigClassStdVecString.klass, "capacity", VALUEFUNC(_wrap_StdVecString_capacity), -1);
  rb_define_method(SwigClassStdVecString.klass, "map_bang", VALUEFUNC(_wrap_StdVecString_map_bang), -1);
  rb_define_method(SwigClassStdVecString.klass, "__delete__", VALUEFUNC(_wrap_StdVecString___delete__), -1);
  SwigClassStdVecString.mark = 0;
  SwigClassStdVecString.destroy = (void (*)(void *)) free_std_vector_Sl_std_string_Sg_;
  SwigClassStdVecString.trackObjects = 0;
  
  SwigClassStdVecVecString.klass = rb_define_class_under(mStl, "StdVecVecString", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_std__vectorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__allocatorT_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t, (void *) &SwigClassStdVecVecString);
  rb_include_module(SwigClassStdVecVecString.klass, rb_eval_string("Enumerable"));
  rb_define_alloc_func(SwigClassStdVecVecString.klass, _wrap_StdVecVecString_allocate);
  rb_define_method(SwigClassStdVecVecString.klass, "initialize", VALUEFUNC(_wrap_new_StdVecVecString), -1);
  rb_define_method(SwigClassStdVecVecString.klass, "dup", VALUEFUNC(_wrap_StdVecVecString_dup), -1);
  rb_define_method(SwigClassStdVecVecString.klass, "inspect", VALUEFUNC(_wrap_StdVecVecString_inspect), -1);
  rb_define_method(SwigClassStdVecVecString.klass, "to_a", VALUEFUNC(_wrap_StdVecVecString_to_a), -1);
  rb_define_method(SwigClassStdVecVecString.klass, "to_s", VALUEFUNC(_wrap_StdVecVecString_to_s), -1);
  rb_define_method(SwigClassStdVecVecString.klass, "slice", VALUEFUNC(_wrap_StdVecVecString_slice), -1);
  rb_define_method(SwigClassStdVecVecString.klass, "each", VALUEFUNC(_wrap_StdVecVecString_each), -1);
  rb_define_method(SwigClassStdVecVecString.klass, "__delete2__", VALUEFUNC(_wrap_StdVecVecString___delete2__), -1);
  rb_define_method(SwigClassStdVecVecString.klass, "select", VALUEFUNC(_wrap_StdVecVecString_select), -1);
  rb_define_method(SwigClassStdVecVecString.klass, "delete_at", VALUEFUNC(_wrap_StdVecVecString_delete_at), -1);
  rb_define_method(SwigClassStdVecVecString.klass, "at", VALUEFUNC(_wrap_StdVecVecString_at), -1);
  rb_define_method(SwigClassStdVecVecString.klass, "[]", VALUEFUNC(_wrap_StdVecVecString___getitem__), -1);
  rb_define_method(SwigClassStdVecVecString.klass, "[]=", VALUEFUNC(_wrap_StdVecVecString___setitem__), -1);
  rb_define_method(SwigClassStdVecVecString.klass, "reject!", VALUEFUNC(_wrap_StdVecVecString_rejectN___), -1);
  rb_define_alias(SwigClassStdVecVecString.klass, "delete_if", "reject!");
  rb_define_method(SwigClassStdVecVecString.klass, "pop", VALUEFUNC(_wrap_StdVecVecString_pop), -1);
  rb_define_method(SwigClassStdVecVecString.klass, "push", VALUEFUNC(_wrap_StdVecVecString_push), -1);
  rb_define_alias(SwigClassStdVecVecString.klass, "<<", "push");
  rb_define_method(SwigClassStdVecVecString.klass, "reject", VALUEFUNC(_wrap_StdVecVecString_reject), -1);
  rb_define_method(SwigClassStdVecVecString.klass, "shift", VALUEFUNC(_wrap_StdVecVecString_shift), -1);
  rb_define_method(SwigClassStdVecVecString.klass, "unshift", VALUEFUNC(_wrap_StdVecVecString_unshift), -1);
  rb_define_method(SwigClassStdVecVecString.klass, "empty?", VALUEFUNC(_wrap_StdVecVecString_emptyq___), -1);
  rb_define_method(SwigClassStdVecVecString.klass, "size", VALUEFUNC(_wrap_StdVecVecString_size), -1);
  rb_define_method(SwigClassStdVecVecString.klass, "swap", VALUEFUNC(_wrap_StdVecVecString_swap), -1);
  rb_define_method(SwigClassStdVecVecString.klass, "begin", VALUEFUNC(_wrap_StdVecVecString_begin), -1);
  rb_define_method(SwigClassStdVecVecString.klass, "end", VALUEFUNC(_wrap_StdVecVecString_end), -1);
  rb_define_method(SwigClassStdVecVecString.klass, "rbegin", VALUEFUNC(_wrap_StdVecVecString_rbegin), -1);
  rb_define_method(SwigClassStdVecVecString.klass, "rend", VALUEFUNC(_wrap_StdVecVecString_rend), -1);
  rb_define_method(SwigClassStdVecVecString.klass, "clear", VALUEFUNC(_wrap_StdVecVecString_clear), -1);
  rb_define_method(SwigClassStdVecVecString.klass, "get_allocator", VALUEFUNC(_wrap_StdVecVecString_get_allocator), -1);
  rb_define_method(SwigClassStdVecVecString.klass, "erase", VALUEFUNC(_wrap_StdVecVecString_erase), -1);
  rb_define_method(SwigClassStdVecVecString.klass, "front", VALUEFUNC(_wrap_StdVecVecString_front), -1);
  rb_define_method(SwigClassStdVecVecString.klass, "back", VALUEFUNC(_wrap_StdVecVecString_back), -1);
  rb_define_method(SwigClassStdVecVecString.klass, "assign", VALUEFUNC(_wrap_StdVecVecString_assign), -1);
  rb_define_method(SwigClassStdVecVecString.klass, "resize", VALUEFUNC(_wrap_StdVecVecString_resize), -1);
  rb_define_method(SwigClassStdVecVecString.klass, "insert", VALUEFUNC(_wrap_StdVecVecString_insert), -1);
  rb_define_method(SwigClassStdVecVecString.klass, "reserve", VALUEFUNC(_wrap_StdVecVecString_reserve), -1);
  rb_define_method(SwigClassStdVecVecString.klass, "capacity", VALUEFUNC(_wrap_StdVecVecString_capacity), -1);
  SwigClassStdVecVecString.mark = 0;
  SwigClassStdVecVecString.destroy = (void (*)(void *)) free_std_vector_Sl_std_vector_Sl_std_string_Sg__Sg_;
  SwigClassStdVecVecString.trackObjects = 0;
  
  SwigClassMapStringString.klass = rb_define_class_under(mStl, "MapStringString", rb_cObject);
  ...
  rb_define_module_function(mStl, "vec_len", VALUEFUNC(_wrap_vec_len), -1);
  rb_define_module_function(mStl, "get_hash_x", VALUEFUNC(_wrap_get_hash_x), -1);
  rb_define_module_function(mStl, "first_string", VALUEFUNC(_wrap_first_string), -1);
}
